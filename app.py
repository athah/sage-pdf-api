...
def build_ai_insights(data, st):
    ...
    story.append(Paragraph(
        "The following analysis was generated by an AI language model. It synthesises "
        "the quantitative metrics above into qualitative narrative and strategic direction. "
        "Account managers should review, edit, and personalise before client delivery.",
        st["body"]))
    story.append(Spacer(1, 8))
...
def build_recommendations(data, st):
    ...
    story.append(Paragraph(
        "The following strategic recommendations are based on the performance patterns observed "
        "this period. They are intended as a starting point for the account management discussion.",
        st["body"]))
    story.append(Spacer(1, 10))
